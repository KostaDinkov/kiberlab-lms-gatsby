...
export default function Cookies() {
  return (
    <PageLayout>
      <h1>Cookie Policy for kiberlab-lms-gatsby</h1>
      <p>This is the Cookie Policy for kiberlab-lms-gatsby, accessible from https://kiberlab-lms-gatsby.netlify.app/</p>
      ...
      <ul>
        <li>Email: k.v.dinkov@gmail.com</li>
      </ul>
    </PageLayout>
  )
}